        ...
        <form action="${headPath }/board/qnaUpdate.do" method="post">
            <table class="table" id="myTable">
                ...
                <tr>
                    ...
                    <td><input type="text" class="input" name="title" id="title" value="${courseQna.title}"></td>
                    <td>${courseQna.author}</td>
                    <td>
                        <fmt:parseDate value="${courseQna.regdate }" var="resdate" pattern="yyyy-MM-dd HH:mm:ss" />
                        <fmt:formatDate value="${resdate }" pattern="yyyy-MM-dd" />
                    </td>
                    <td>${courseQna.visited}</td>
                </tr>
                <tr>
                    <td colspan="5">
                        <textarea name="content" id="content" cols="30" rows="10" class="textarea">${courseQna.content}</textarea>
                    </td>
                </tr>
                </tbody>
            </table>

            <input type="hidden" name="qno" id="qno" value="${courseQna.qno}">

            <div class="buttons is-centered">
                <a href="${headPath }/board/courseQnaList.do" class="button is-mainColor">목록</a>
