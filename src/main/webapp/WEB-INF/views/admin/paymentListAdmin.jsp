                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center">수강 번호</th>
                                        <th class="text-center">배송상태</th>
                                        <th class="text-center">결제 방법</th>
                                        <th class="text-center">결제 대행사</th>
                                        <th class="text-center">결제카드</th>
                                    ...
                                    <c:forEach items="${paymentList }" var="pay" varStatus="status">
                                        <tr>
                                            ...
                                            <td class="text-center"> ${pay.sno } </td>
                                            <td class="text-center"> ${pay.status } </td>
                                            <td class="text-center">${pay.pmethod }</td>
                                            <td class="text-center">${pay.pcom }</td>
                                            <td class="text-center">${pay.pnum }</td>
